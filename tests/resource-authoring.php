...
$service = new ResourceDraftService($repository, new ResourceDraftValidator());
...
author_expect($first['resource_id'] === 'r1' && $first['resource_version_id'] === 'v1', 'patient education resources create a draft version');

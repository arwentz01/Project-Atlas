...
final class ResourcesModule implements Module
{
    ...
    public function register(Container $container): void
    {
        ...
        add_action('admin_post_atlas_snapshot_packet',[$this->packets,'snapshot']);
        ...
        add_action('admin_post_atlas_create_insurance_profile',[$this->sources,'createInsuranceProfile']);
        add_action('admin_post_atlas_create_dme_category',[$this->sources,'createDmeCategory']);
        add_action('admin_post_atlas_update_checklist_state',[$this->sources,'updateChecklist']);
    }
    ...
    public function registerRoutes(): void
    {
        ...
        register_rest_route('atlas/v1','/insurance-profiles',['methods'=>'GET','callback'=>[$this->sourceController,'insuranceProfiles'],'permission_callback'=>[$this->sourceController,'readPermission']]);
        register_rest_route('atlas/v1','/insurance-profiles',['methods'=>'POST','callback'=>[$this->sourceController,'createInsuranceProfile'],'permission_callback'=>[$this->sourceController,'reviewPermission']]);
        register_rest_route('atlas/v1','/dme-categories',['methods'=>'GET','callback'=>[$this->sourceController,'dmeCategories'],'permission_callback'=>[$this->sourceController,'readPermission']]);
        register_rest_route('atlas/v1','/dme-categories',['methods'=>'POST','callback'=>[$this->sourceController,'createDmeCategory'],'permission_callback'=>[$this->sourceController,'reviewPermission']]);
        register_rest_route('atlas/v1','/dme-requirement-matches',['methods'=>'GET','callback'=>[$this->sourceController,'dmeMatches'],'permission_callback'=>[$this->sourceController,'readPermission']]);
        register_rest_route('atlas/v1','/documentation-checklists',['methods'=>'GET','callback'=>[$this->sourceController,'checklist'],'permission_callback'=>[$this->sourceController,'readPermission']]);
        register_rest_route('atlas/v1','/documentation-checklists/export',['methods'=>'GET','callback'=>[$this->sourceController,'checklistExport'],'permission_callback'=>[$this->sourceController,'readPermission']]);
        register_rest_route('atlas/v1','/coverage-summaries/export',['methods'=>'GET','callback'=>[$this->sourceController,'coverageSummaryExport'],'permission_callback'=>[$this->sourceController,'readPermission']]);
        register_rest_route('atlas/v1','/payer-requirements/(?P<id>[a-fA-F0-9-]{36})/evidence',['methods'=>'GET','callback'=>[$this->sourceController,'evidence'],'permission_callback'=>[$this->sourceController,'readPermission']]);
        register_rest_route('atlas/v1','/payer-requirements/(?P<id>[a-fA-F0-9-]{36})/coverage-summary',['methods'=>'GET','callback'=>[$this->sourceController,'coverageSummary'],'permission_callback'=>[$this->sourceController,'readPermission']]);
        register_rest_route('atlas/v1','/payer-requirements/(?P<id>[a-fA-F0-9-]{36})/checklist',['methods'=>'POST','callback'=>[$this->sourceController,'updateChecklist'],'permission_callback'=>[$this->sourceController,'reviewPermission']]);
        ...
        register_rest_route('atlas/v1','/packets/options',['methods'=>'GET','callback'=>[$this->packetController,'options'],'permission_callback'=>[$this->packetController,'permission']]);
        ...
        register_rest_route('atlas/v1','/packets/(?P<id>[a-fA-F0-9-]{36})/snapshots',['methods'=>'POST','callback'=>[$this->packetController,'snapshot'],'permission_callback'=>[$this->packetController,'createPermission']]);
    }

...
define('ATLAS_VERSION','0.6.0');define('ATLAS_FILE',__FILE__);define('ATLAS_DIR',plugin_dir_path(__FILE__));define('ATLAS_URL',plugin_dir_url(__FILE__));
...
require_once ATLAS_DIR.'src/FrontEnd/Views/KnowledgeBase.php';
require_once ATLAS_DIR.'src/FrontEnd/ModuleRegistry.php';
require_once ATLAS_DIR.'src/FrontEnd/App.php';
require_once ATLAS_DIR.'src/Plugin.php';
Atlas\FrontEnd\ModuleRegistry::boot();
Atlas\Plugin::boot();

...
$sections = [
    ...
    [
        ...
        'features' => [
            ...
            'Owner-only Demo Testing Center with role expectations and guided smoke-test loop',
            'Repeat-safe edge-case fixtures for approvals, trades, coverage gaps, expired credentials, and missed punches',
            'Protected demo reset and deletion controls that cannot target real organizations',
